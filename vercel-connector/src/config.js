...
function readConfig() {
  ...
  return {
    ...
    geofenceAllowedReasonCodes: envAsNumberList(process.env.GEOFENCE_ALLOWED_REASON_CODES, [20, 2]),
    geofenceMaxRecalcAgeSec: Number(process.env.GEOFENCE_MAX_RECALC_AGE_SEC || 900),
    webhookCanonicalDeviceIdStrict: envAsBoolean(process.env.WEBHOOK_CANONICAL_DEVICE_ID_STRICT, true),
    geofenceBatchConflictSuppress: envAsBoolean(process.env.GEOFENCE_BATCH_CONFLICT_SUPPRESS, true),
    vibrationStrictDedupe: envAsBoolean(process.env.VIBRATION_STRICT_DEDUPE, true),
